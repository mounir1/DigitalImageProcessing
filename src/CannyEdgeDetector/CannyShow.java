 ...
 * User interface
 * <p>
 * Edited By Mounir Abderrahmani
 * Original @author Andrea Maglie
 */
public class CannyShow extends JApplet {
    ...
    public static void main(String[] args) {
        ...
        image1 = tool.getImage(imageFile);
        image1 = image1.getScaledInstance(350, 350, Image.SCALE_DEFAULT);
        edgeDetector.setSourceImage(image1);
        ...
        outputLabel = new JLabel("the output image");
